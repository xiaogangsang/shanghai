  ...
  <div class="panel-group" id="menu">
    ...
    <div class="panel">
      ...
      <div id="menu1" class="panel-collapse collapse">
        <div class="list-group">
          <a href="class.html" class="list-group-item" id="menu-class">万达票类管理</a>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div id="menu3" class="panel-collapse collapse" role="tabpanel">
        <div class="list-group">
          <a href="movie.html" class="list-group-item" id="menu-movie">标准影片库</a>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div id="menu4" class="panel-collapse collapse" role="tabpanel">
        <div class="list-group">
          <a href="showtime.html" class="list-group-item" id="menu-showtime">场次查询</a>
          <a href="charge.html" class="list-group-item" id="menu-charge">服务费设置</a>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div id="menu6" class="panel-collapse collapse" role="tabpanel">
        <div class="list-group">
          <a href="banner.html" class="list-group-item" id="menu-banner">前端配置管理</a>
        </div>
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div id="menu8" class="panel-collapse collapse" role="tabpanel">
        <div class="list-group">
          <a href="report.html" class="list-group-item" id="menu-report">运营报表</a>
        </div>
      </div>
    </div>
